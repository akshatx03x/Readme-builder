...
import GeminiChatUI from "./components/GeminiUi";
...
            className="text-yellow-400 font-medium py-2 px-4 rounded-full border border-yellow-400 hover:bg-yellow-400 hover:text-zinc-900 transition-colors duration-200 mt-2 block w-max"
          >
            Visit your profile
          </a>
        </div>
