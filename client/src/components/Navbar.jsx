...
const Navbar = () => {
    ...
    return (
        <div className="flex items-center justify-between px-5 font-medium">
           <Link to='/'><img src="" alt="logo" className="w-36 py-5" /></Link>
            ...
            <div className="flex item-center gap-6">
                ...
                <Link to='/cart' className="relative" >
                    <img src=""alt="cart icon" className="w-5 cursor-pointer" />
                ...
                <img onClick={() => setvisible(true)} src="" className="w-5 cursor-pointer sm:hidden" alt="" />
            </div>
